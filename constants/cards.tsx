...
export const cards: Card[] = [
  ...
  },
  {
    ...
    type: CardType.Event,
    increaseParameter: [Temperature],
    gainResource: [Titanium, Titanium],
    removeAnyResource: [Plant]
  },
  {
    cost: 21,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    tags: [Tag.Event, Tag.Space],
    type: CardType.Event,
    increaseParameter: [Temperature, Temperature],
    gainResource: Array(4).fill(Titanium),
    removeAnyResource: Array(4).fill(Plant)
  },
  {
    actionOrEffectText:
  ...
  },
  {
    ...
    type: CardType.Automated,
    victoryPoints: 1,
    gainResource: [Plant, Plant, Plant],
    placeTile: [t(TileType.City)],
    decreaseProduction: [Energy],
    increaseProduction: [Megacredit, Megacredit, Megacredit]
  },
  {
    cost: 18,
    deck: Deck.Basic,
    ...
    type: CardType.Automated,
    decreaseProduction: [Energy],
    increaseParameter: Array(3).fill(Megacredit),
    placeTile: [t(TileType.Noctis, Location.Noctis)]
  },
  {
    cost: 28,
    deck: Deck.Basic,
    ...
    type: CardType.Automated,
    victoryPoints: 2,
    increaseProduction: [...Array(2).fill(Heat), ...Array(2).fill(Plant)]
  },
  {
    cost: 16,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    type: CardType.Active,
    placeTile: [t(TileType.City, Location.Isolated)]
  },
  {
    cost: 25,
    deck: Deck.Basic,
    ...
    victoryPoints: 3,
    increaseProduction: [Titanium],
    placeTile: [t(TileType.City, Location.Phobos)]
  },
  {
    cost: 15,
    deck: Deck.Basic,
    ...
    type: CardType.Automated,
    placeTile: [t(TileType.Ocean)],
    decreaseProduction: [Megacredit, Megacredit],
  ...
  },
  {
    ...
    effect: effect => effect.gainResource(Plant, 2),
    gainResource: [Plant]
  },
  {
    actionOrEffectText:
  ...
  },
  {
    ...
    type: CardType.Automated,
    victoryPoints: 1,
    gainResource: [Animal, Plant, Plant, Plant],
    increaseProduction: [Megacredit, Megacredit]
  },
  {
    cost: 24,
    deck: Deck.Corporate,
  ...
  },
  {
    ...
    placeTile: [t(TileType.City)],
    decreaseProduction: [Energy],
    increaseProduction: Array(3).fill(Megacredit)
  },
  {
    cost: 13,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    effect: effect => {
      effect.gainResource(Megacredit, 3);
      effect.gainResource(Heat, 3);
    }
  },
  {
    cost: 18,
    ...
    type: CardType.Automated,
    placeTile: [t(TileType.City)],
    decreaseProduction: [Energy, Energy],
    increaseProduction: [Steel, Steel]
  },
  {
    actionOrEffectText:
  ...
  },
  {
    ...
    tags: [Tag.Event, Tag.Space],
    type: CardType.Event,
    increaseParameter: [TerraformRating, Temperature, Temperature],
  ...
  },
  {
    ...
    effect: effect => {
      effect.gainResource(Megacredit, 2);
    }
  },
  {
    cost: 31,
    ...
    tags: [Tag.Event, Tag.Space],
    type: CardType.Event,
    increaseParameter: Array(3).fill(Temperature),
    removeAnyResource: Array(8).fill(Plant)
  },
  {
    cost: 30,
    deck: Deck.Basic,
    ...
    type: CardType.Automated,
    victoryPoints: 2,
    increaseProduction: [Titanium, Titanium]
  },
  {
    cost: 12,
    deck: Deck.Basic,
    ...
    increaseProduction: Array(4).fill(Megacredit)
  },
  {
    cost: 6,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    type: CardType.Automated,
    victoryPoints: 1,
    placeTile: [t(TileType.NaturalPreserve, Location.Isolated)],
  ...
  },
  {
    ...
    type: CardType.Automated,
    decreaseProduction: [Megacredit, Megacredit],
    increaseProduction: [Energy, Energy]
  },
  {
    cost: 8,
    deck: Deck.Corporate,
    ...
    type: CardType.Automated,
    victoryPoints: 1,
    increaseProduction: [Energy, Megacredit]
  },
  {
    cost: 10,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    type: CardType.Event,
    loseAnyResourceOption: [Array(2).fill(Animal), Array(5).fill(Plant)]
  },
  {
    cost: 12,
    deck: Deck.Corporate,
  ...
  },
  {
    ...
    type: CardType.Automated,
    victoryPoints: 1,
    increaseProduction: [...Array(3).fill(Heat), ...Array(3).fill(Energy)]
  },
  {
    cost: 12,
    deck: Deck.Basic,
    ...
    type: CardType.Automated,
    victoryPoints: 1,
    placeTile: [t(TileType.Greenery, Location.ReservedForOcean)]
  },
  {
    cost: 13,
    deck: Deck.Basic,
    ...
    type: CardType.Automated,
    victoryPoints: 1,
    increaseProduction: [Plant, Plant, Plant],
    gainResource: [Plant]
  },
  {
    cost: 6,
  ...
  },
  {
    ...
    removeAnyResource: [Plant, Plant],
    gainResource: [Steel, Steel]
  },
  {
    cost: 4,
    deck: Deck.Corporate,
    ...
    get increaseProduction() {
      ...
      return bonus.includes(Steel) ? [Steel] : [Titanium];
    }
  },
  {
    cost: 6,
  ...
  },
  {
    ...
    tags: [Tag.Building],
    type: CardType.Automated,
    placeTile: [t(TileType.Mining, Location.SteelOrTitanium)]
  },
  {
    cost: 6,
    deck: Deck.Corporate,
  ...
  },
  {
    ...
    placeTile: [t(TileType.Ocean), t(TileType.Ocean)],
    increaseParameter: [Temperature, Temperature],
    removeAnyResource: Array(6).fill(Plant)
  },
  {
    cost: 20,
    deck: Deck.Basic,
    ...
    type: CardType.Automated,
    placeTile: [t(TileType.City, Location.Ganymede)],
    get victoryPoints() {
      if (!this.state) return [];
      return this.state.tags.filter(tag => tag === Tag.Jovian).length;
    }
  ...
  },
  {
    ...
    type: CardType.Automated,
    decreaseProduction: [Energy],
    increaseProduction: [Megacredit, Megacredit, Megacredit, Megacredit]
  },
  {
    cost: 9,
    deck: Deck.Corporate,
    ...
    oneTimeAction(action) {
      action.duplicateBuildingTagProduction();
    }
  },
  {
    cost: 11,
  ...
  },
  {
    ...
    tags: [Tag.Jovian, Tag.Space],
    type: CardType.Automated,
    increaseProduction: [Titanium, Titanium, Megacredit, Megacredit]
  },
  {
    cost: 10,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    get increaseProduction() {
      ...
      return this.state.cards
        .filter(card => !card.ownedByCurrentPlayer)
  ...
  },
  {
    ...
    type: CardType.Event,
    victoryPoints: -2,
    increaseParameter: [TerraformRating, TerraformRating]
  },
  {
    cost: 11,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    type: CardType.Automated,
    victoryPoints: 1,
    placeTile: [t(TileType.Ocean, Location.NotReservedForOcean)]
  },
  {
    cost: 11,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    type: CardType.Automated,
    victoryPoints: 2,
    increaseProduction: [Megacredit, Megacredit, Plant, Plant],
    gainResource: [Plant, Plant]
  },
  {
    cost: 2,
  ...
  },
  {
    ...
    tags: [Tag.Building, Tag.City],
    type: CardType.Automated,
    placeTile: [t(TileType.City, Location.DoubleCityAdjacent)]
  },
  {
    cost: 1,
    deck: Deck.Corporate,
  ...
  },
  {
    ...
    victoryPoints: -1,
    decreaseProduction: [Energy],
    decreaseAnyProduction: [Megacredit, Megacredit],
    increaseProduction: [Megacredit, Megacredit]
  },
  {
    cost: 11,
    ...
    type: CardType.Automated,
    decreaseProduction: [Energy],
    increaseProduction: [Heat, Heat, Heat, Heat]
  },
  {
    cost: 11,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    effect(effect) {
      effect.gainResource(Animal, 1, this);
    },
    placeTile: [t(TileType.EcologicalZone, Location.GreeneryAdjacent)]
  },
  {
    cost: 13,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    get increaseProduction() {
      if (!this.state) return [];
      const numMicrobeTags = this.state.tags.filter(tag => tag === Tag.Microbe)
        .length;
  ...
  },
  {
    ...
    type: CardType.Automated,
    get increaseProduction() {
      return this.tags.filter(tag => tag === Tag.Earth).fill(Megacredit);
    }
  },
  {
    cost: 25,
    ...
    tags: [Tag.Building],
    type: CardType.Automated,
    increaseParameter: [Oxygen, Oxygen],
    increaseProduction: [Steel, Steel, Titanium],
    decreaseProduction: [Energy, Energy]
  },
  {
    cost: 8,
  ...
  },
  {
    ...
    type: CardType.Event,
    increaseParameter: [Temperature, Temperature],
    placeTile: [t(TileType.LavaFlow, Location.Volcanic)]
  },
  {
    cost: 4,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    tags: [Tag.Building],
    type: CardType.Automated,
    placeTile: [t(TileType.MoholeArea, Location.ReservedForOcean)]
  },
  {
    cost: 36,
    deck: Deck.Basic,
    ...
    placeTile: [t(TileType.Ocean)],
    gainResource: [Resource.Card, Resource.Card],
    gainResourceOption: [Array(5).fill(Plant), Array(4).fill(Animal)]
  },
  {
    cost: 7,
    deck: Deck.Corporate,
  ...
  },
  {
    ...
    get increaseProduction() {
      ...
      return this.state.tags.filter(tag => tag === Tag.Plant).fill(Plant);
    }
  },
  {
    cost: 1,
  ...
  },
  {
    ...
    type: CardType.Event,
    decreaseProduction: [Megacredit],
    gainResource: Array(10).fill(Megacredit)
  },
  {
    cost: 2,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    tags: [Tag.Earth, Tag.Event, Tag.Space],
    type: CardType.Event,
    increaseProduction: [Heat],
    gainResource: [Heat, Heat, Heat]
  },
  {
  ...
  },
  {
    ...
    tags: [Tag.Building],
    type: CardType.Automated,
    decreaseProduction: Array(4).fill(Energy),
    increaseProduction: [Plant, Plant],
  ...
  },
  {
    ...
    type: CardType.Automated,
    victoryPoints: 2,
    increaseProduction: [Plant, Megacredit, Megacredit],
    gainResource: [Plant]
  },
  {
    cost: 26,
    ...
    tags: [Tag.Event, Tag.Space],
    type: CardType.Event,
    gainResource: [Microbe, Microbe],
    increaseProduction: [...Array(3).fill(Heat), Plant]
  },
  {
    terraformRatingIncrease: 1,
    cost: 5,
  ...
  },
  {
    ...
    type: CardType.Automated,
    victoryPoints: -1,
    decreaseAnyProduction: [Heat, Heat],
    increaseProduction: [Energy]
  },
  {
    cost: 9,
  ...
  },
  {
    ...
    type: CardType.Automated,
    decreaseProduction: [Energy],
    increaseProduction: [Titanium, Megacredit]
  },
  {
    cost: 5,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    condition: condition => condition.tag === Tag.Science,
    effect: effect =>
      effect.addOrRemoveOneResource(Science, () => {
        effect.drawCard();
      })
  },
  {
  ...
  },
  {
    ...
    gainResourceOption: [Array(4).fill(Plant), Array(2).fill(Animal)]
  },
  {
    cost: 8,
    deck: Deck.Basic,
  ...
  },
  {
    ...
    tags: [Tag.Science],
    type: CardType.Active,
    placeTile: [t(TileType.RestrictedArea)]
  },
  {
    actionOrEffectText:
    ...
    type: CardType.Active,
    condition: condition => condition.tileType === TileType.City,
    effect: effect => effect.increaseProduction(Megacredit, 1),
    decreaseProduction: [Energy, Megacredit, Megacredit],
    placeTile: [t(TileType.City)]
  },
  {
    cost: 3,
  ...
  },
  {
    ...
    tags: [Tag.Space],
    type: CardType.Automated,
    increaseProduction: Array(7).fill(Heat)
  },
  {
    cost: 5,
    deck: Deck.Corporate,
  ...
  },
  {
    ...
    get increaseProduction() {
      ...
      return Array(half).fill(Megacredit);
    }
  },
  {
  ...
  },
  {
    ...
    effect: effect => effect.gainResource(Megacredit, 4),
    gainResource: Array(57).fill(Megacredit)
  },
  {
    actionOrEffectText:
    ...
    tags: [Tag.Plant],
    type: CardType.Corporation,
    gainResource: [...Array(36).fill(Megacredit), ...Array(3).fill(Plant)],
    increaseProduction: [Plant, Plant]
  },
  {
    actionOrEffectText:
    ...
    tags: [Tag.Space],
    type: CardType.Corporation,
    increaseProduction: [Heat, Heat, Heat],
  ...
  },
  {
    ...
    type: CardType.Corporation,
    gainResource: [...Array(30).fill(Megacredit), ...Array(5).fill(Steel)],
    increaseProduction: [Steel]
  },
  {
    actionOrEffectText:
  ...
  },
  {
    ...
    tags: [Tag.Earth],
    type: CardType.Corporation,
    gainResource: Array(60).fill(Megacredit)
  },
  {
    actionOrEffectText:
  ...
  },
  {
    ...
    type: CardType.Corporation,
    increaseProduction: [Energy],
    gainResource: Array(48).fill(Megacredit)
  },
  {
    actionOrEffectText:
...
export const cardsDict: {[key: string]: Card} = {};
